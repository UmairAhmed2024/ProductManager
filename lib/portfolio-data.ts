export const portfolioData = {
  ...
  experience: [
    {
      ...
      // description:
      //   'Owned end-to-end product strategy and delivery for fintech solutions across payments and digital banking.',
      achievements: [
    ...
    },
    {
      ...
      location: 'Jhelum, PK',
      // description:
      //   'Supported senior stakeholders across multiple concurrent initiatives, ensuring on-time delivery and cross-team alignment.',
      achievements: [
    ...
    },
    {
      ...
      location: 'Jhelum, PK',
      // description:
      //   'Developed and maintained frontend web applications, building a strong technical foundation in UI and modern web technologies.',
      achievements: [
  ...
  certifications: [
    { name: 'Anti-Money Laundering & Counter Terrorist Financing (AML/CFT)', issuer: 'Compliance Training' },
    { name: 'Financial Crime Prevention & Fraud Detection', issuer: 'Financial Training' },
    { name: 'APP Fraud Reimbursement', issuer: 'Professional Certification' },
    { name: 'Fraud Prevention (Global)', issuer: 'Professional Certification' },
    { name: 'Sanctions Compliance', issuer: 'Compliance Training' },
    { name: 'General Data Protection Regulation (GDPR)', issuer: 'Compliance Certification' },
    { name: 'Information Security & Cyber Risk Awareness', issuer: 'Security Training' },
    { name: 'Creative Designing', issuer: 'Design Course' },
    { name: 'Agile & Project Management', issuer: 'Workshops / Seminars' },
    { name: 'Software Testing & Quality Assurance', issuer: 'Professional Training' },
  ],
